    ...
    <Container id="events">
      ...
      <Content>
        ...
        {status === "No events" && (
          ...
          /* TODO cambiar esto por valores de la api de eventbrite */
          <div className="organizing">
            <a
              aria-label="Meetup 29 de agosto"
              href="http://bit.ly/fccba-agosto-2020"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img alt="Meetup 29 de agosto" src={image} />
            </a>
            <h4>
              ¡Este 29/8 tenemos una <strong>Meetup virtual</strong>!
            </h4>
          </div>
        )}
          ...
          <EventBox>
            <EventBox.Left>
              ...
              <div className="info">
                <h5>Fecha</h5>
                <p>
                  {dayjs(nextEvent.time).format(
                    "dddd D [de] MMMM [a las] H[hs]"
                  )}
                </p>
              </div>
